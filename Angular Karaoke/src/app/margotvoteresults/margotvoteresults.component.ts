...
@Component({
  selector: 'cl-margotvoteresults',
  templateUrl: './margotvoteresults.component.html',
  styleUrls: ['./margotvoteresults.component.css']
})
export class MargotvoteresultsComponent implements OnInit {

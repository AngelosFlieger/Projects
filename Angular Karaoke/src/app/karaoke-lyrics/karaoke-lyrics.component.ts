...
@Component({
  selector: 'cl-karaoke-lyrics',
  templateUrl: './karaoke-lyrics.component.html',
  styleUrls: ['./karaoke-lyrics.component.css']
})
export class KaraokeLyricsComponent implements OnInit {
